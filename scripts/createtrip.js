...
$(document).ready(function () {
    ...
    function toggleFromVisibility() {
        $(".trip-from").css({ "display": toggleFromDropdown === "none" ? "block" : "none" });
    ...
    function toggleToVisibility() {
        $(".trip-to").css({ "display": toggleToDropdown === "none" ? "block" : "none" });
    ...
    window.onclick = function (e) {
        ...
        if (toggleFromDropdown === "block") {
            if (!FromContainer.is(e.target) && FromContainer.has(e.target).length == 0) {
                $(".trip-from").css({ "display": "none" });
...
$(document).ready(function () {
    ...
    function toggleSearchFromVisibility() {
        $(".trip-from-search").css({ "display": toggleSFromDropdown === "none" ? "block" : "none" });
    ...
    function toggleSearchToVisibility() {
        $(".trip-to-search").css({ "display": toggleSToDropdown === "none" ? "block" : "none" });
    ...
    window.onclick = function (e) {
        ...
        if (toggleSFromDropdown === "block") {
            if (!SearchFromContainer.is(e.target) && SearchFromContainer.has(e.target).length == 0) {
                $(".trip-from-search").css({ "display": "none" });
                toggleSFromDropdown = "none"
            }
        }
        if (toggleSToDropdown === "block") {
            if (!SearchToContainer.is(e.target) && SearchToContainer.has(e.target).length == 0) {
    ...
    $('#markers_info .marker').hover(
        ...
        function () {
            ...
            var markers = [
                ...
                ['Jeeva Park',13.0440, 80.2378],
                ['Chetpet Ecopark', 13.6440, 80.2378],
